...
```
1. Read the project convention file (CLAUDE.md, AGENTS.md, or equivalent)
...
- [ ] Simplified code follows project conventions (checked against the project convention file)
